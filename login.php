...
try {
    ...
    echo "Error loading styles: " . $e->getMessage();
}
?>
          ...
          <div class="user-details">
            <div class="input-box">
              ...
              <input type="email" placeholder="Enter your Email" name="id"
                value="<?php if (isset($_POST['id'])) echo $_POST['id']; ?>" required>
            </div>
            <div class="input-box">
            ...
            try {
                ...
                die("Error loading connection file: " . $e->getMessage());
            }
            ...
            if (isset($_POST['login'])) {
              try {
                  ...
                  if ($row) { // Check if $row is not null
                      ...
                      echo "<span class='alert alert-danger'>No user found with the provided credentials</span>";
                  }
              } catch (Exception $e) {
                  echo "<span class='alert alert-danger'>An error occurred: " . $e->getMessage() . "</span>";
              }
            }
            ?>
            ...
            <p><a href="register.php" style="color:black ; font-size:20px ; font-weight: bold;margin-left:90px; "
                onmouseover="this.style.color='blue'" onmouseOut="this.style.color='black'"> New user? Register.</a></p>
        </form>
      </div>
    </div>
    </div>
