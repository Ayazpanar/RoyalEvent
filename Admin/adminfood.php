  ...
  <div class="container1">
    ...
    <div class="content">
      ...
      <div class="user-details">
        ...
        <div class="input-box" style="margin-left:0px;margin-top:-20px">
          <span class="details">Description</span>
          <textarea  id="desc" rows="5" cols="140" placeholder="Enter Description" required></textarea>
        </div>
      </div>
    </div>
  </div>
      ...
      while ($rec = mysqli_fetch_array($rs)) {
        ...
        <tr style="text-align:justify;">
          ...
          <td> <button type="button" class="btn btn-primary"
              onclick="submitData('update',<?php echo $rec['Fid'] ?>);">update</button> </td>
          <td><button type="button" class="btn btn-danger"
              onclick="submitData('delete',<?php echo $rec['Fid'] ?>);">Delete</button> </td>
        </tr>
        <?php
      }
