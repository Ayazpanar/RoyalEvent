...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 29, 2024 at 12:20 PM
...
(16, 'Ayaz Panar', 10000, 100000, 20000, 140400, '2024-08-29', 'pay_OqgBgk6hEQNksi', 13);
...
(4, 'Wedding', 'Santokba Hall', 'Gujarati', 14374, 170, '2023-04-28', '2023-04-26', '00:12', '17:05', 'Canceled', '2023-04-29', 'Pending', 2),
...
(28, 'Wedding', 'Santokba Hall', 'Non-veg', 20000, 500, '2024-10-10', '2024-10-12', '10:00', '22:00', 'Active', '2024-08-29', 'Success', 13);
...
(15, 'Images/ayaz.png', 'Brother', 'Ayaz Panar', '2001-10-30', '0001-01-01', 13),
(16, 'Images/ali.png', 'Son', 'Ali', '2002-10-16', '0000-00-00', 13);
...
INSERT INTO `foodmenu` (`Fid`, `Foodtype`, `Price`, `Catno`, `Catname`, `fdesc`) VALUES
(1, 'Gujarati', 100, '9887857498', 'Bansi Catering', 'The Gujarati Thali consists of various dishes like ringana methi nu shak, Gujarati khatti mithi daal'),
(2, 'Panjabi', 150, '9998456958', 'Kohinoor Catering', 'It typically includes a combination of curries, rice, bread, and accompaniments.'),
(3, 'South-Indian', 80, '9658745885', 'Apple Catering', 'It is recommended to have the combination of rasam, sambar, sabzi or palya, dessert and a salad.'),
(4, 'Non-veg', 200, '9745856984', 'Alpha Catering', 'Indian non vegetarian thali collection that included meat, seafood, or egg dishes. Perfect to plan a'),
(5, 'Mix-Foods', 250, '9658458654', 'Star Catering', 'Flexible to any thing included mix items veg as well as non-veg.'),
(6, 'None', 0, '', '', 'no food included');
...
(1, 'Ayaz', 'Car Decoration', 2000, '2023-04-11', 'Canceled', 'Success', 'husahfoahfoha', 2),
...
(17, 'Ayaz Panar', 'Car Decoration', 5000, '2024-08-29', 'Active', 'Success', 'pay_OqfloctTrQtif1', 13);
...
CREATE TABLE `usermaster` (
  `UId` int(4) NOT NULL COMMENT 'To store userid',
...
(13, 'Ayaz Panar', 'Users/IMG_20230301_151020.jpg', '9909130787', 'ayazpanar0786@gmail.com', 'Ayaz@2001', 'developer', '2001-10-30', 'Male', 'Solara ni pole near loteshvar', 'patan', '384265');
...
--
ALTER TABLE `admin`
  MODIFY `Aid` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `billmaster`
--
ALTER TABLE `billmaster`
  MODIFY `BId` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `eventmaster`
  MODIFY `Eid` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `familyinfo`
--
ALTER TABLE `familyinfo`
  MODIFY `mid` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `foodmenu`
--
ALTER TABLE `foodmenu`
  MODIFY `Fid` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `gallery`
--
ALTER TABLE `gallery`
  MODIFY `Gid` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;

--
-- AUTO_INCREMENT for table `offers`
--
ALTER TABLE `offers`
  MODIFY `Oid` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `servicemaster`
  MODIFY `Sid` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `usermaster`
--
ALTER TABLE `usermaster`
  MODIFY `UId` int(4) NOT NULL AUTO_INCREMENT COMMENT 'To store userid', AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `venuemaster`
--
ALTER TABLE `venuemaster`
  MODIFY `VId` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
COMMIT;
