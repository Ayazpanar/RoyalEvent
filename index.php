...
<header class="header">
	...
	<div class="header-cta">
		...
		<div class="container">
			...
			<center>
				<h3
					style="color:white;border:black;position:absolute;left:200px;top:400px;spacing:20px;word-spacing: 2px;">
					Whether you're looking to book a party,Wedding, Birthday, Babyshower,<br>
					business meeting,Engagement or private dining event, our dedicated <b>Royal Events</b> team can
					create a package <br>
